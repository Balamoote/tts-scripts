...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[223]++; if(dbg){print "R223", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[230]++; if(dbg){print "R230", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[234]++; if(dbg){print "R234", "sw_es_r_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[237]++; if(dbg){print "R237", "sw_ez_i_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[240]++; if(dbg){print "R240", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[241]++; if(dbg){print "R241", "sw_em_v_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[244]++; if(dbg){print "R244", "sw_em_r_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[247]++; if(dbg){print "R247", "sw_ez_i_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[250]++; if(dbg){print "R250", "sw_mn_r_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if(iwrd=="свою") {
   ...
   l[i]=omo1; R[256]++; if(dbg){print "R256"}; continue # свою́
 };
 #
 if ( pre_vi(-1) &&
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[265]++; if(dbg){print "R265", "sw_ez_d_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[266]++; if(dbg){print "R266", "sw_em_v_f"}; continue };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( gl_in(1) && s(0) )
 { l[i]=omo1; R[270]++; if(dbg){print "R270"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if(iwrd=="толку") {
   if ( w(-1,"что") && s(-1) )
   { l[i]=omo2; R[273]++; if(dbg){print "R273"}; continue };
   if ( w(1,"от") &&
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if(iwrd=="уйму") {
   if ( q(1,"suw_ro") && s(0) )
   { l[i]=omo2; R[294]++; if(dbg){print "R294"}; continue };
 };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if(iwrd=="переходим") {
   ...
   if ( w(1,cst) && s(0) )
   { l[i]=omo1; R[322]++; if(dbg){print "R322"}; continue };
 };
 #
 if ( gl_mn1e_f() )
 ...
 #
 if ( pl_kr_em_f() )
 { l[i]=omo2; R[324]++; if(dbg){print "R324", "pl_kr_em_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pq_kr_em_f() )
 { l[i]=omo2; R[326]++; if(dbg){print "R326", "pq_kr_em_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[328]++; if(dbg){print "R328", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[329]++; if(dbg){print "R329", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[331]++; if(dbg){print "R331", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_t_f() )
 { l[i]=omo2; R[333]++; if(dbg){print "R333", "sw_es_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[335]++; if(dbg){print "R335", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_pomn_f() )
 { l[i]=omo2; R[339]++; if(dbg){print "R339", "gl_pomn_f"}; continue };
 #
 if ( sw_em_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[342]++; if(dbg){print "R342", "sw_em_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[343]++; if(dbg){print "R343", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[344]++; if(dbg){print "R344", "sw_ez_p_f"}; continue };
 #
 if ( gl_mn2e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pq_kr_em_f() )
 { l[i]=omo2; R[346]++; if(dbg){print "R346", "pq_kr_em_f"}; continue };
 #
 if ( gl_mn3e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[350]++; if(dbg){print "R350", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[351]++; if(dbg){print "R351", "sw_mn_r_f"}; continue };
 #
 if ( gl_mn3e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[356]++; if(dbg){print "R356"}; continue };
 #
 if ( pl_kr_em_f() )
 { l[i]=omo2; R[357]++; if(dbg){print "R357", "pl_kr_em_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[362]++; if(dbg){print "R362", "sw_mn_r_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[363]++; if(dbg){print "R363", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[364]++; if(dbg){print "R364", "sw_em_v_f"}; continue };
...
#{ print l[i+1] >> "_sw.txt"; R[368]++; if(dbg){print "R368"}; }; continue
 #
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[377]++; if(dbg){print "R377", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[378]++; if(dbg){print "R378", "sw_em_v_f"}; continue };
 #
 if ( gl_paedmu_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[382]++; if(dbg){print "R382", "gl_paedmu_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[383]++; if(dbg){print "R383", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[384]++; if(dbg){print "R384", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[388]++; if(dbg){print "R388", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[389]++; if(dbg){print "R389", "sw_es_v_f"}; continue };
 #
 if ( gl_paedsr_f() )
 { l[i]=omo1; R[390]++; if(dbg){print "R390", "gl_paedsr_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[393]++; if(dbg){print "R393", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[400]++; if(dbg){print "R400", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[401]++; if(dbg){print "R401", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[402]++; if(dbg){print "R402", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[404]++; if(dbg){print "R404", "sw_em_i_f"}; continue };
 #
 if ( gl_paedze_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[406]++; if(dbg){print "R406", "sw_em_r_f"}; continue };
 #
 if ( gl_paedze_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo2; R[416]++; if(dbg){print "R416", "gl_poed_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[419]++; if(dbg){print "R419", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[420]++; if(dbg){print "R420", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[425]++; if(dbg){print "R425", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[426]++; if(dbg){print "R426", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[427]++; if(dbg){print "R427", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( p(-1) && sc(0,"!") && w(0,cst) )
 { l[i]=omo1; R[449]++; if(dbg){print "R449"}; continue };
 if ( q(-1,"pre_any") && s(-1) )
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[452]++; if(dbg){print "R452", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[453]++; if(dbg){print "R453", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[454]++; if(dbg){print "R454", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[469]++; if(dbg){print "R469", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_pamn_f() )
 { l[i]=omo2; R[475]++; if(dbg){print "R475", "gl_pamn_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[480]++; if(dbg){print "R480", "sw_em_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[483]++; if(dbg){print "R483", "sw_es_d_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[484]++; if(dbg){print "R484", "sw_es_p_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[485]++; if(dbg){print "R485", "sw_es_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[490]++; if(dbg){print "R490", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[496]++; if(dbg){print "R496", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[499]++; if(dbg){print "R499", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_pomn_f() )
 { l[i]=omo1; R[511]++; if(dbg){print "R511", "gl_pomn_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[512]++; if(dbg){print "R512", "sw_em_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[514]++; if(dbg){print "R514", "pq_kr_em_f"}; continue };
 #
 if ( sw_em_t_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_mn1e_f() )
 { l[i]=omo1; R[516]++; if(dbg){print "R516", "gl_mn1e_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[517]++; if(dbg){print "R517", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[518]++; if(dbg){print "R518", "gl_poed_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[519]++; if(dbg){print "R519", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[529]++; if(dbg){print "R529", "sw_em_p_f"}; continue };
 #
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( sc(-1,"-") )
 { l[i]=omo2; R[531]++; if(dbg){print "R531"}; continue };
 if ( sc(0,"-") )
 { l[i]=omo2; R[532]++; if(dbg){print "R532"}; continue };
 #
 if ( gl_poed_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[541]++; if(dbg){print "R541", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[548]++; if(dbg){print "R548", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[551]++; if(dbg){print "R551", "gl_poed_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[552]++; if(dbg){print "R552", "sw_em_d_f"}; continue };
 #
 if ( pl_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[558]++; if(dbg){print "R558", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[559]++; if(dbg){print "R559", "sw_em_d_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[560]++; if(dbg){print "R560", "gl_ed1e_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[563]++; if(dbg){print "R563", "gl_poed_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[564]++; if(dbg){print "R564", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[565]++; if(dbg){print "R565", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[566]++; if(dbg){print "R566", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[567]++; if(dbg){print "R567", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[568]++; if(dbg){print "R568", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[569]++; if(dbg){print "R569"}; continue };
 if ( w(-3,"на") &&
      q(-2,"qin_im qik_im") &&
      q(-1,"suw_ro") &&
      q(1,"suw_ro") && s(-3,0) )
 ...
 #
 if ( pl_srav_f() )
 { l[i]=omo2; R[589]++; if(dbg){print "R589", "pl_srav_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[593]++; if(dbg){print "R593", "sw_em_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo2; R[594]++; if(dbg){print "R594", "pl_kr_ez_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[596]++; if(dbg){print "R596", "sw_em_t_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[597]++; if(dbg){print "R597", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[598]++; if(dbg){print "R598", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_p_f() )
 { l[i]=omo1; R[601]++; if(dbg){print "R601", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { R[602]++; if(dbg){print "R602", "stopper"}; continue };
 if ( w(-1,"на") && s(-1) && p(-2) && bfa(1,3,"_gl_dvizh") && s(0,bfn-1) )
 { R[603]++; if(dbg){print "R603", "stopper"}; continue };
 ...
 if ( sw_es_i_f() )
 { l[i]=omo2; R[611]++; if(dbg){print "R611", "sw_es_i_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[612]++; if(dbg){print "R612", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[613]++; if(dbg){print "R613", "sw_ez_p_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[614]++; if(dbg){print "R614", "sw_es_p_f"}; continue };
 #
 if ( sw_es_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[618]++; if(dbg){print "R618", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[619]++; if(dbg){print "R619", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[620]++; if(dbg){print "R620", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[621]++; if(dbg){print "R621", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[622]++; if(dbg){print "R622", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_l_f() )
 { l[i]=omo1; R[627]++; if(dbg){print "R627", "sw_ez_l_f"}; continue };
 #
 if ( sw_ez_z_f() )
 { l[i]=omo2; R[628]++; if(dbg){print "R628", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[629]++; if(dbg){print "R629", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[630]++; if(dbg){print "R630", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[631]++; if(dbg){print "R631", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if(iwrd=="души") {
   ...
   { l[i]=omo1; R[635]++; if(dbg){print "R635"}; continue };
 };
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[636]++; if(dbg){print "R636", "gl_poed_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[637]++; if(dbg){print "R637", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[647]++; if(dbg){print "R647", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[651]++; if(dbg){print "R651", "sw_es_r_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[652]++; if(dbg){print "R652", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[657]++; if(dbg){print "R657", "gl_poed_f"}; continue };
 #
 if ( sw_mn_i_f() )
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[660]++; if(dbg){print "R660", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[661]++; if(dbg){print "R661", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[663]++; if(dbg){print "R663", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[666]++; if(dbg){print "R666", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[667]++; if(dbg){print "R667", "sw_mn_v_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[668]++; if(dbg){print "R668", "sw_ez_r_f"}; continue };
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[669]++; if(dbg){print "R669", "pl_krmn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[670]++; if(dbg){print "R670", "gl_poed_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[671]++; if(dbg){print "R671", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo1; R[672]++; if(dbg){print "R672", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo1; R[673]++; if(dbg){print "R673", "sw_mn_r_f"}; continue };
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[674]++; if(dbg){print "R674", "pl_kr_em_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[675]++; if(dbg){print "R675", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[676]++; if(dbg){print "R676", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[677]++; if(dbg){print "R677", "sw_em_i_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[678]++; if(dbg){print "R678", "sw_ez_t_f"}; continue };
 #
 if ( pl_ez_d_f() )
 { l[i]=omo1; R[679]++; if(dbg){print "R679", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo1; R[680]++; if(dbg){print "R680", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo1; R[681]++; if(dbg){print "R681", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo1; R[682]++; if(dbg){print "R682", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
#if ( sL(0,"-") && w(1,cst) )
#{ l[i]=gensub(/(.)$/,"\\1\xcc\x81",1,l[i]); sep[i]=gensub(/-/,"-\xcc\xa0",1,sep[i]); R[688]++; if(dbg){print "R688"}; continue };
#if ( sL(-1,"-") && w(-1,"кое") )
#{ l[i]=gensub(/(.)$/,"\\1\xcc\x81",1,l[i]); R[689]++; if(dbg){print "R689"}; continue };
 if ( sL(0,"-") && w(1,cst) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_p_f() )
 { l[i]=omo2; R[696]++; if(dbg){print "R696", "sw_mn_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[697]++; if(dbg){print "R697", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[698]++; if(dbg){print "R698", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[700]++; if(dbg){print "R700", "sw_em_d_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if(iwrd=="целиком")
 { l[i]=omo1; R[702]++; if(dbg){print "R702", "nar_spos_"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_d_f() )
 { l[i]=omo2; R[703]++; if(dbg){print "R703", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo2; R[704]++; if(dbg){print "R704", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo2; R[705]++; if(dbg){print "R705", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo2; R[706]++; if(dbg){print "R706", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[719]++; if(dbg){print "R719", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[720]++; if(dbg){print "R720", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[723]++; if(dbg){print "R723", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[724]++; if(dbg){print "R724", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[725]++; if(dbg){print "R725", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[726]++; if(dbg){print "R726", "sw_mn_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[727]++; if(dbg){print "R727", "sw_em_p_f"}; continue };
 #
 if ( sw_em_t_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[729]++; if(dbg){print "R729", "sw_em_d_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[731]++; if(dbg){print "R731", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[732]++; if(dbg){print "R732", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[733]++; if(dbg){print "R733", "pl_em_p_f()||pl_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[734]++; if(dbg){print "R734", "pl_em_p_f()||pl_es_p_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[735]++; if(dbg){print "R735", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_t_f() )
 { l[i]=omo2; R[737]++; if(dbg){print "R737", "sw_es_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[738]++; if(dbg){print "R738", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 #
 if ( pl_es_i_f() )
 { l[i]=omo1; R[741]++; if(dbg){print "R741", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo1; R[742]++; if(dbg){print "R742", "pl_es_v_f"}; continue };
 #
 if ( pl_srav_f() )
 { l[i]=omo2; R[743]++; if(dbg){print "R743", "pl_srav_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[746]++; if(dbg){print "R746", "sw_em_v_f"}; continue };
 #
 if ( pl_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_d_f() )
 { l[i]=omo1; R[752]++; if(dbg){print "R752", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo1; R[753]++; if(dbg){print "R753", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo1; R[754]++; if(dbg){print "R754", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo1; R[755]++; if(dbg){print "R755", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[756]++; if(dbg){print "R756", "sw_mn_r_f"}; continue };
 #
 if ( pl_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[761]++; if(dbg){print "R761", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[762]++; if(dbg){print "R762", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[763]++; if(dbg){print "R763", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[764]++; if(dbg){print "R764", "sw_es_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[765]++; if(dbg){print "R765", "sw_mn_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[766]++; if(dbg){print "R766", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[767]++; if(dbg){print "R767", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_ez_v_f() )
 { l[i]=omo1; R[768]++; if(dbg){print "R768", "pl_ez_v_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[769]++; if(dbg){print "R769", "sw_es_d_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[771]++; if(dbg){print "R771", "sw_em_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[773]++; if(dbg){print "R773", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[774]++; if(dbg){print "R774", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[779]++; if(dbg){print "R779", "sw_em_t_f"}; continue };
 #
 if ( pl_kr_em_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[782]++; if(dbg){print "R782", "pl_kr_em_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[783]++; if(dbg){print "R783", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[786]++; if(dbg){print "R786", "pl_kr_em_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[787]++; if(dbg){print "R787", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[788]++; if(dbg){print "R788", "sw_mn_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[790]++; if(dbg){print "R790", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[791]++; if(dbg){print "R791", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[796]++; if(dbg){print "R796", "sw_em_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[798]++; if(dbg){print "R798", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[799]++; if(dbg){print "R799", "sw_em_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[800]++; if(dbg){print "R800", "pl_kr_ez_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[801]++; if(dbg){print "R801", "sw_es_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[803]++; if(dbg){print "R803", "sw_ez_i_f"}; continue };
 #
 if ( pl_kr_ez_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[806]++; if(dbg){print "R806", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[809]++; if(dbg){print "R809", "sw_ez_r_f"}; continue };
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[810]++; if(dbg){print "R810", "pl_krmn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[811]++; if(dbg){print "R811", "sw_mn_i_f"}; continue };
 #
 if ( pl_krmn_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[817]++; if(dbg){print "R817", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[819]++; if(dbg){print "R819", "pl_srav_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[820]++; if(dbg){print "R820", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[821]++; if(dbg){print "R821", "pl_srav_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[822]++; if(dbg){print "R822", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[825]++; if(dbg){print "R825", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[830]++; if(dbg){print "R830", "pq_kr_em_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[831]++; if(dbg){print "R831", "pq_kr_em_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[832]++; if(dbg){print "R832", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[833]++; if(dbg){print "R833", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[834]++; if(dbg){print "R834", "pq_kr_em_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[836]++; if(dbg){print "R836", "pl_kr_ez_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[837]++; if(dbg){print "R837", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[838]++; if(dbg){print "R838", "pl_kr_ez_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[839]++; if(dbg){print "R839", "sw_ez_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[840]++; if(dbg){print "R840", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[841]++; if(dbg){print "R841", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[842]++; if(dbg){print "R842", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[843]++; if(dbg){print "R843", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[844]++; if(dbg){print "R844", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[845]++; if(dbg){print "R845", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[846]++; if(dbg){print "R846", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[847]++; if(dbg){print "R847", "sw_mn_d_f"}; continue };
 #
 if ( sw_mn_d_f() )
 { l[i]=omo2; R[848]++; if(dbg){print "R848", "sw_mn_d_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[849]++; if(dbg){print "R849", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[850]++; if(dbg){print "R850", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[857]++; if(dbg){print "R857", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[858]++; if(dbg){print "R858", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[859]++; if(dbg){print "R859", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[864]++; if(dbg){print "R864", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[868]++; if(dbg){print "R868", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo1; R[869]++; if(dbg){print "R869", "sw_ez_v_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[870]++; if(dbg){print "R870", "sw_em_l_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[871]++; if(dbg){print "R871", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[876]++; if(dbg){print "R876", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( w(-1,"с") && s(-1) )
 { l[i]=omo2; R[878]++; if(dbg){print "R878", "sw_em_z_f"}; continue };
 #
 if ( sw_em_z_f() )
 { l[i]=omo2; R[879]++; if(dbg){print "R879", "sw_em_z_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[880]++; if(dbg){print "R880", "sw_em_d_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[881]++; if(dbg){print "R881", "sw_em_l_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo1; R[882]++; if(dbg){print "R882", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo1; R[883]++; if(dbg){print "R883", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo1; R[884]++; if(dbg){print "R884", "sw_es_v_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[885]++; if(dbg){print "R885", "sw_em_p_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo1; R[886]++; if(dbg){print "R886", "sw_es_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[887]++; if(dbg){print "R887", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[892]++; if(dbg){print "R892", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[893]++; if(dbg){print "R893", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[895]++; if(dbg){print "R895", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[897]++; if(dbg){print "R897", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[904]++; if(dbg){print "R904", "sw_em_d_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo1; R[905]++; if(dbg){print "R905", "sw_es_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo1; R[906]++; if(dbg){print "R906", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[917]++; if(dbg){print "R917", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[918]++; if(dbg){print "R918", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[919]++; if(dbg){print "R919", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[923]++; if(dbg){print "R923", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[926]++; if(dbg){print "R926", "sw_es_z_f()||sw_es_i_f()||sw_es_v_f()||sw_es_r_f()||sw_es_d_f()||sw_es_t_f()||sw_es_p_f()||sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[929]++; if(dbg){print "R929", "sw_ez_i_f"}; continue };
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[930]++; if(dbg){print "R930", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[931]++; if(dbg){print "R931", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[934]++; if(dbg){print "R934", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_l_f() )
 { l[i]=omo2; R[940]++; if(dbg){print "R940", "sw_ez_l_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[947]++; if(dbg){print "R947", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[951]++; if(dbg){print "R951", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[952]++; if(dbg){print "R952", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_l_f() )
 { l[i]=omo2; R[956]++; if(dbg){print "R956", "sw_ez_l_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[957]++; if(dbg){print "R957", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[958]++; if(dbg){print "R958", "sw_ez_r_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[959]++; if(dbg){print "R959", "sw_ez_p_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[960]++; if(dbg){print "R960", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[961]++; if(dbg){print "R961", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[962]++; if(dbg){print "R962", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[963]++; if(dbg){print "R963", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo1; R[964]++; if(dbg){print "R964", "sw_mn_r_f"}; continue };
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[965]++; if(dbg){print "R965", "pl_kr_em_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_d_f() )
 { l[i]=omo2; R[966]++; if(dbg){print "R966", "sw_mn_d_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[967]++; if(dbg){print "R967", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[968]++; if(dbg){print "R968", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[971]++; if(dbg){print "R971", "sw_em_l_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
#{ l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[972]++; if(dbg){print "R972"}; continue };
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[975]++; if(dbg){print "R975", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
#{ l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[976]++; if(dbg){print "R976"}; continue };
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[977]++; if(dbg){print "R977", "sw_em_z_f"}; continue };
 #
 if ( sw_em_l_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
#if ( ismark(-1,"Ykl") && notsym(-1,unxy) && s(-1) )
#{ l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[982]++; if(dbg){print "R982"}; continue };
 #
 if ( sw_em_l_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[985]++; if(dbg){print "R985", "sw_em_p_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[990]++; if(dbg){print "R990", "sw_ez_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[993]++; if(dbg){print "R993", "sw_em_i_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[994]++; if(dbg){print "R994", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[997]++; if(dbg){print "R997", "sw_em_z_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[998]++; if(dbg){print "R998", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[999]++; if(dbg){print "R999", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1003]++; if(dbg){print "R1003", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1004]++; if(dbg){print "R1004", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[1019]++; if(dbg){print "R1019", "sw_em_t_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1020]++; if(dbg){print "R1020", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1021]++; if(dbg){print "R1021", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1023]++; if(dbg){print "R1023", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_p_f() )
 { l[i]=omo2; R[1024]++; if(dbg){print "R1024", "sw_mn_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1027]++; if(dbg){print "R1027", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1028]++; if(dbg){print "R1028", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[1035]++; if(dbg){print "R1035", "sw_em_d_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[1036]++; if(dbg){print "R1036", "sw_es_d_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[1037]++; if(dbg){print "R1037", "sw_em_l_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1038]++; if(dbg){print "R1038", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1039]++; if(dbg){print "R1039", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1040]++; if(dbg){print "R1040", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1047]++; if(dbg){print "R1047", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 ...
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1050]++; if(dbg){print "R1050", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[1051]++; if(dbg){print "R1051", "sw_em_p_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[1052]++; if(dbg){print "R1052", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1053]++; if(dbg){print "R1053", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1054]++; if(dbg){print "R1054", "sw_es_v_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[1055]++; if(dbg){print "R1055", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[1056]++; if(dbg){print "R1056", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[1057]++; if(dbg){print "R1057", "sw_em_p_f"}; continue };
 #
#if ( sw_es_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1061]++; if(dbg){print "R1061", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1062]++; if(dbg){print "R1062", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_q_f() )
 { l[i]=omo1; R[1063]++; if(dbg){print "R1063", "sw_em_q_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1064]++; if(dbg){print "R1064", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1069]++; if(dbg){print "R1069", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1071]++; if(dbg){print "R1071", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1085]++; if(dbg){print "R1085", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1086]++; if(dbg){print "R1086", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1090]++; if(dbg){print "R1090", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1093]++; if(dbg){print "R1093", "sw_em_p_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[1094]++; if(dbg){print "R1094", "sw_es_p_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[1095]++; if(dbg){print "R1095", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[1096]++; if(dbg){print "R1096", "sw_em_t_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[1097]++; if(dbg){print "R1097", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( nar_spos_f() )
 { l[i]=omo1; R[1100]++; if(dbg){print "R1100", "nar_spos_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[1101]++; if(dbg){print "R1101", "sw_em_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1102]++; if(dbg){print "R1102", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1108]++; if(dbg){print "R1108", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1116]++; if(dbg){print "R1116", "sw_em_r_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1117]++; if(dbg){print "R1117", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1118]++; if(dbg){print "R1118", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1119]++; if(dbg){print "R1119", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1120]++; if(dbg){print "R1120", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1121]++; if(dbg){print "R1121", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1122]++; if(dbg){print "R1122", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1134]++; if(dbg){print "R1134", "gl_paedmu_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1135]++; if(dbg){print "R1135", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_d_f() )
 { l[i]=omo1; R[1136]++; if(dbg){print "R1136", "sw_es_d_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1137]++; if(dbg){print "R1137", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_d_f() )
 { l[i]=omo1; R[1138]++; if(dbg){print "R1138", "sw_es_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo1; R[1140]++; if(dbg){print "R1140", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1141]++; if(dbg){print "R1141", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_i_f() )
 { l[i]=omo1; R[1143]++; if(dbg){print "R1143", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo1; R[1144]++; if(dbg){print "R1144", "sw_es_v_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[1145]++; if(dbg){print "R1145", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1146]++; if(dbg){print "R1146", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1147]++; if(dbg){print "R1147", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1148]++; if(dbg){print "R1148", "sw_ez_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1149]++; if(dbg){print "R1149", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_p_f() )
 { l[i]=omo1; R[1150]++; if(dbg){print "R1150", "sw_es_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1151]++; if(dbg){print "R1151", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1152]++; if(dbg){print "R1152", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1153]++; if(dbg){print "R1153", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1154]++; if(dbg){print "R1154", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1155]++; if(dbg){print "R1155", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1157]++; if(dbg){print "R1157", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1168]++; if(dbg){print "R1168", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1169]++; if(dbg){print "R1169", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1172]++; if(dbg){print "R1172", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1173]++; if(dbg){print "R1173", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1181]++; if(dbg){print "R1181", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[1182]++; if(dbg){print "R1182", "sw_ez_t_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1183]++; if(dbg){print "R1183", "sw_ez_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[1184]++; if(dbg){print "R1184", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[1186]++; if(dbg){print "R1186", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_p_f() )
 { l[i]=omo1; R[1189]++; if(dbg){print "R1189", "sw_mn_p_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_p_f() )
 { l[i]=omo1; R[1191]++; if(dbg){print "R1191", "sw_mn_p_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1206]++; if(dbg){print "R1206", "sw_mn_r_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1207]++; if(dbg){print "R1207", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1213]++; if(dbg){print "R1213", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[1224]++; if(dbg){print "R1224", "sw_em_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1232]++; if(dbg){print "R1232", "sw_es_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[1233]++; if(dbg){print "R1233", "pl_kr_ez_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[1234]++; if(dbg){print "R1234", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[1235]++; if(dbg){print "R1235", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1313]++; if(dbg){print "R1313", "sw_es_z_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[1314]++; if(dbg){print "R1314", "sw_ez_i_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1315]++; if(dbg){print "R1315", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1316]++; if(dbg){print "R1316", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1317]++; if(dbg){print "R1317", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1324]++; if(dbg){print "R1324", "sw_em_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1326]++; if(dbg){print "R1326", "sw_ez_i_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1327]++; if(dbg){print "R1327", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1348]++; if(dbg){print "R1348", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_v_f() )
 { l[i]=omo2; R[1353]++; if(dbg){print "R1353", "pl_ez_v_f"}; continue };
 #
 if ( suw_mnvi(1) && s(0) )
 { l[i]=omo1; R[1354]++; if(dbg){print "R1354"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1355]++; if(dbg){print "R1355", "gl_ed1e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[1386]++; if(dbg){print "R1386", "gl_poed_f"}; continue };
 #
#if ( gl_in_f() )
#{ l[i]=omo1; R[1387]++; if(dbg){print "R1387"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1388]++; if(dbg){print "R1388", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1389]++; if(dbg){print "R1389", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[1390]++; if(dbg){print "R1390", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[1395]++; if(dbg){print "R1395", "sw_em_z_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1396]++; if(dbg){print "R1396", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1397]++; if(dbg){print "R1397", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1398]++; if(dbg){print "R1398", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1399]++; if(dbg){print "R1399", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1400]++; if(dbg){print "R1400", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1401]++; if(dbg){print "R1401", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1402]++; if(dbg){print "R1402", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( bw(-1,"мочка") && s(-1) )
 { l[i]=omo1; R[1403]++; if(dbg){print "R1403", "sw_es_r_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1404]++; if(dbg){print "R1404", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1405]++; if(dbg){print "R1405", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_z_f() )
 { l[i]=omo1; R[1408]++; if(dbg){print "R1408", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1409]++; if(dbg){print "R1409", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1415]++; if(dbg){print "R1415", "sw_em_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1424]++; if(dbg){print "R1424", "gl_paedmu_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1425]++; if(dbg){print "R1425", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[1426]++; if(dbg){print "R1426", "sw_em_z_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[1431]++; if(dbg){print "R1431", "gl_poed_f"}; continue };
 #
 if ( sw_ez_z_f() )
 { l[i]=omo2; R[1432]++; if(dbg){print "R1432", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[1433]++; if(dbg){print "R1433", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1434]++; if(dbg){print "R1434", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1435]++; if(dbg){print "R1435", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( bw(-1,cst) && s(-1) )
 { l[i]=omo2; R[1436]++; if(dbg){print "R1436", "gl_paedsr_f"}; continue };
 cst="достаточнош немного слишком черезчур";
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo2; R[1437]++; if(dbg){print "R1437", "gl_paedsr_f"}; continue };
 if ( q(-2,"prl_kred_sr") &&
sz_iili(-1) && s(-2,-1) )
 { l[i]=omo2; R[1438]++; if(dbg){print "R1438", "gl_paedsr_f"}; continue };
 ...
 if ( gl_paedsr_f() )
 { l[i]=omo1; R[1442]++; if(dbg){print "R1442", "gl_paedsr_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( w(-1,"на") && s(-1) )
 { l[i]=omo2; R[1443]++; if(dbg){print "R1443", "sw_ez_d_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[1444]++; if(dbg){print "R1444", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1445]++; if(dbg){print "R1445", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1446]++; if(dbg){print "R1446", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if(iwrd=="полке") {
   if ( w(-1,"на") && s(-1) )
   { l[i]=omo2; R[1448]++; if(dbg){print "R1448"}; continue };
 };
 if(iwrd=="жаре") {
   if ( w(-1,"на по") && s(-1) )
 ...
 if(iwrd=="спине") {
   prex=0
   if ( sw_em_p_f() )
   { l[i]=omo2; R[1451]++; if(dbg){print "R1451", "sw_em_p_f"}; continue };
   prex=1
 };
 #
 if ( sw_em_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1456]++; if(dbg){print "R1456", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1458]++; if(dbg){print "R1458", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1459]++; if(dbg){print "R1459", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1460]++; if(dbg){print "R1460", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( w(-1,"друг") && s(-1) )
 { l[i]=omo2; R[1463]++; if(dbg){print "R1463", "sw_em_t_f"}; continue };
 if ( q(-2,"suw_tv") &&
sz_iili(-1) && s(-2,-1) )
 { l[i]=omo2; R[1464]++; if(dbg){print "R1464", "sw_em_t_f"}; continue };
 #
 if ( sw_em_p_f()||sw_es_p_f()||pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[1465]++; if(dbg){print "R1465", "sw_em_p_f||sw_es_p_f||pl_em_p_f||pl_es_p_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[1466]++; if(dbg){print "R1466", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[1467]++; if(dbg){print "R1467", "pl_srav_f"}; continue };
 #
 cst="значительно куда лишь много намного немного несколько";
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo1; R[1468]++; if(dbg){print "R1468"}; continue };
 if ( nar_vrem_f() )
 { l[i]=omo1; R[1469]++; if(dbg){print "R1469", "nar_vrem_f"}; continue };
 #
 if ( pl_es_i_f() )
 { l[i]=omo2; R[1470]++; if(dbg){print "R1470", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo2; R[1471]++; if(dbg){print "R1471", "pl_es_v_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[1472]++; if(dbg){print "R1472", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[1473]++; if(dbg){print "R1473", "sw_em_d_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1474]++; if(dbg){print "R1474", "gl_ed1e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[1475]++; if(dbg){print "R1475", "sw_ez_d_f"}; continue };
 #
 if ( sw_em_p_f() )           ##_footer
 { l[i]=omo1; R[1476]++; if(dbg){print "R1476", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1477]++; if(dbg){print "R1477", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_em_p_f() )
 { l[i]=omo2; R[1479]++; if(dbg){print "R1479", "sw_ez_d_f"}; continue };
 #
 if ( pl_es_p_f() )
 { l[i]=omo2; R[1480]++; if(dbg){print "R1480", "sw_em_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[1481]++; if(dbg){print "R1481", "sw_ez_d_f"}; continue };
 #
 if ( pl_srav_f() )
 { l[i]=omo2; R[1482]++; if(dbg){print "R1482", "sw_em_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( q(1,"suw_ro") && s(0) )
 { l[i]=omo2; R[1484]++; if(dbg){print "R1484"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1485]++; if(dbg){print "R1485", "sw_mn_r_f"}; continue };
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1486]++; if(dbg){print "R1486", "gl_paedmu_f"}; continue };
...
#{ l[i]=omo1; l[i+1]=gensub(/^(.+)$/,"\xcc\xa0\\1\xcc\xa0",1,l[i+1]); R[1488]++; if(dbg){print "R1488"}; continue };
 if ( sL(0,"-") )
 { l[i]=omo1; R[1489]++; if(dbg){print "R1489"}; continue };
 #
 if ( pl_ez_i_f() )
 { l[i]=omo1; R[1490]++; if(dbg){print "R1490", "pl_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 if ( q(-1,"nar_step") && s(-1) )
 { l[i]=omo1; R[1492]++; if(dbg){print "R1492"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1493]++; if(dbg){print "R1493", "sw_em_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[1494]++; if(dbg){print "R1494", "pl_kr_ez_f"}; continue };
 #
 if ( sw_ez_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1497]++; if(dbg){print "R1497", "sw_ez_r_f"}; continue };
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[1498]++; if(dbg){print "R1498", "pl_krmn_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1499]++; if(dbg){print "R1499", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[1500]++; if(dbg){print "R1500", "sw_em_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1501]++; if(dbg){print "R1501", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if(iwrd=="они") {
   l[i]=omo2; R[1502]++; if(dbg){print "R1502"}; continue # они́
 };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if(iwrd=="собой") {
   l[i]=omo2; R[1503]++; if(dbg){print "R1503"}; continue # они́
 };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo3; R[1510]++; if(dbg){print "R1510", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1511]++; if(dbg){print "R1511", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1512]++; if(dbg){print "R1512", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo3; R[1514]++; if(dbg){print "R1514", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1515]++; if(dbg){print "R1515", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1516]++; if(dbg){print "R1516", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1517]++; if(dbg){print "R1517", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo3; R[1518]++; if(dbg){print "R1518", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1520]++; if(dbg){print "R1520", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1521]++; if(dbg){print "R1521", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo3; R[1522]++; if(dbg){print "R1522", "sw_ez_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[1523]++; if(dbg){print "R1523", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo3; R[1524]++; if(dbg){print "R1524", "sw_ez_v_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1525]++; if(dbg){print "R1525", "gl_ed1e_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1526]++; if(dbg){print "R1526", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1527]++; if(dbg){print "R1527", "sw_es_v_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo3; R[1528]++; if(dbg){print "R1528", "sw_es_p_f"}; continue };
 #
 if ( pl_es_i_f() )
 { l[i]=omo1; R[1529]++; if(dbg){print "R1529", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo1; R[1530]++; if(dbg){print "R1530", "pl_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1532]++; if(dbg){print "R1532", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1533]++; if(dbg){print "R1533", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[1535]++; if(dbg){print "R1535", "sw_em_l_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1536]++; if(dbg){print "R1536", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo3; R[1537]++; if(dbg){print "R1537", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_ed3e_f() )
 { l[i]=omo1; R[1538]++; if(dbg){print "R1538", "gl_ed3e_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo3; R[1539]++; if(dbg){print "R1539", "sw_mn_r_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[1540]++; if(dbg){print "R1540", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1541]++; if(dbg){print "R1541", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1542]++; if(dbg){print "R1542", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo3; R[1543]++; if(dbg){print "R1543", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo3; R[1544]++; if(dbg){print "R1544", "sw_ez_p_f"}; continue };
 #
 if ( gl_mn2e_f() )
 { l[i]=omo1; R[1545]++; if(dbg){print "R1545", "gl_mn2e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_mn2e_f() )
 { l[i]=omo3; R[1546]++; if(dbg){print "R1546", "gl_mn2e_f"}; continue };
 #
 if ( gl_pomn_f() )
 { l[i]=omo2; R[1547]++; if(dbg){print "R1547", "gl_pomn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1548]++; if(dbg){print "R1548", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[1549]++; if(dbg){print "R1549", "sw_mn_i_f"}; continue };
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[1550]++; if(dbg){print "R1550", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1551]++; if(dbg){print "R1551", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1553]++; if(dbg){print "R1553", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1554]++; if(dbg){print "R1554", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo3; R[1555]++; if(dbg){print "R1555", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[1556]++; if(dbg){print "R1556", "pl_srav_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1557]++; if(dbg){print "R1557", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1558]++; if(dbg){print "R1558", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo3; R[1559]++; if(dbg){print "R1559", "sw_mn_r_f"}; continue };
