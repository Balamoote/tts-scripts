...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 cst="улицу котлету сосиску оладью";
 if ( w(1,cst) && s(0) )
 { l[i]=omo2; R[265]++; if(dbg){print "R265"}; continue };
 if ( q(-1,"pre_vi") && s(-1) )
 { l[i]=omo2; R[265]++; if(dbg){print "R265"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_kr_em_f() )
 { l[i]=omo2; R[330]++; if(dbg){print "R330", "pl_kr_em_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
#{ print l[i+1] >> "_sw.txt"; R[374]++; if(dbg){print "R374"}; }; continue
 #
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[383]++; if(dbg){print "R383", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[384]++; if(dbg){print "R384", "sw_em_v_f"}; continue };
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[385]++; if(dbg){print "R385", "gl_paedmu_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[390]++; if(dbg){print "R390", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[394]++; if(dbg){print "R394", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[395]++; if(dbg){print "R395", "sw_es_v_f"}; continue };
 #
 if ( gl_paedsr_f() )
 { l[i]=omo1; R[396]++; if(dbg){print "R396", "gl_paedsr_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[398]++; if(dbg){print "R398"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[399]++; if(dbg){print "R399", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[400]++; if(dbg){print "R400", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[401]++; if(dbg){print "R401", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if(iwrd=="начала") {
   if ( w(-2,"с до") &&
        w(-1,"самого") && s(-2,-1) )
   { l[i]=omo2; R[403]++; if(dbg){print "R403"}; continue };
   if ( gl_in(1) && s(0) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[410]++; if(dbg){print "R410", "sw_em_i_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[411]++; if(dbg){print "R411", "gl_paedze_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[412]++; if(dbg){print "R412", "sw_em_r_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[413]++; if(dbg){print "R413", "gl_paedze_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if(iwrd=="попали") {
   ...
   { l[i]=omo1; R[414]++; if(dbg){print "R414"}; continue };
   if ( q(1,"pre_vi") && s(0) )
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo2; R[422]++; if(dbg){print "R422", "gl_poed_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_pamn_f() )
 { l[i]=omo1; R[430]++; if(dbg){print "R430", "gl_pamn_f"}; continue };
 #
 if ( sw_ez_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_pamn_f() )
 { l[i]=omo1; R[435]++; if(dbg){print "R435", "gl_pamn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[437]++; if(dbg){print "R437", "gl_poed_f"}; continue };
 #
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[450]++; if(dbg){print "R450", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[451]++; if(dbg){print "R451", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( p(-1) && sc(0,"!") && w(0,cst) )
 { l[i]=omo1; R[455]++; if(dbg){print "R455"}; continue };
 if ( q(-1,"pre_any") && s(-1) )
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[458]++; if(dbg){print "R458", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[459]++; if(dbg){print "R459", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
...
##
#if ( sw_mn_i_f() )
#{ l[i]=omo2; R[470]++; if(dbg){print "R470", "sw_mn_i_f"}; continue };
##
#if ( sw_mn_v_f() )
#{ l[i]=omo2; R[471]++; if(dbg){print "R471", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[475]++; if(dbg){print "R475", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[476]++; if(dbg){print "R476", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[477]++; if(dbg){print "R477", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_pamn_f() )
 { l[i]=omo2; R[481]++; if(dbg){print "R481", "gl_pamn_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[482]++; if(dbg){print "R482", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[483]++; if(dbg){print "R483", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[486]++; if(dbg){print "R486", "sw_em_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[489]++; if(dbg){print "R489", "sw_es_d_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[490]++; if(dbg){print "R490", "sw_es_p_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[491]++; if(dbg){print "R491", "sw_es_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[496]++; if(dbg){print "R496", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[502]++; if(dbg){print "R502", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[505]++; if(dbg){print "R505", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[508]++; if(dbg){print "R508", "sw_mn_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[515]++; if(dbg){print "R515", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_pomn_f() )
 { l[i]=omo1; R[517]++; if(dbg){print "R517", "gl_pomn_f"}; continue };
 #
 if ( sw_em_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_mn1e_f() )
 { l[i]=omo1; R[519]++; if(dbg){print "R519", "gl_mn1e_f"}; continue };
 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[520]++; if(dbg){print "R520", "pq_kr_em_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[521]++; if(dbg){print "R521", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[523]++; if(dbg){print "R523", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[525]++; if(dbg){print "R525", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[527]++; if(dbg){print "R527", "sw_em_t_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[535]++; if(dbg){print "R535", "sw_em_p_f"}; continue };
 #
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[539]++; if(dbg){print "R539", "gl_poed_f"}; continue };
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[540]++; if(dbg){print "R540", "pl_srav_f"}; continue };
 #
 if ( pl_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[546]++; if(dbg){print "R546", "pl_srav_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[547]++; if(dbg){print "R547", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[554]++; if(dbg){print "R554", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[555]++; if(dbg){print "R555", "sw_em_d_f"}; continue };
 #
 if ( gl_ed1e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_d_f() )
 { l[i]=omo2; R[559]++; if(dbg){print "R559", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo2; R[560]++; if(dbg){print "R560", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo2; R[561]++; if(dbg){print "R561", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo2; R[562]++; if(dbg){print "R562", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_z_f() )
 { l[i]=omo2; R[563]++; if(dbg){print "R563", "sw_em_z_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[564]++; if(dbg){print "R564", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[565]++; if(dbg){print "R565", "sw_em_d_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[566]++; if(dbg){print "R566", "gl_ed1e_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_z_f() )
 { l[i]=omo2; R[568]++; if(dbg){print "R568", "sw_em_z_f"}; continue };
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[569]++; if(dbg){print "R569", "gl_poed_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[570]++; if(dbg){print "R570", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[571]++; if(dbg){print "R571", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[572]++; if(dbg){print "R572", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[573]++; if(dbg){print "R573", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[574]++; if(dbg){print "R574", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( w(-3,"на") &&
      ...
      q(-1,"suw_ro") &&
      q(1,"suw_ro") && s(-3,0) )
 { l[i]=omo2; R[576]++; if(dbg){print "R576"}; continue };
 #
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[594]++; if(dbg){print "R594", "sw_em_p_f"}; continue };
 #
 if ( pl_srav_f() )
 { l[i]=omo2; R[595]++; if(dbg){print "R595", "pl_srav_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[598]++; if(dbg){print "R598", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[599]++; if(dbg){print "R599", "sw_em_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo2; R[600]++; if(dbg){print "R600", "pl_kr_ez_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[601]++; if(dbg){print "R601", "pl_em_p_f()||pl_es_p_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[602]++; if(dbg){print "R602", "sw_em_t_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[603]++; if(dbg){print "R603", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[604]++; if(dbg){print "R604", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[605]++; if(dbg){print "R605", "pl_em_p_f()||pl_es_p_f"}; continue };
 #
 if ( sw_es_t_f() )
 { l[i]=omo2; R[606]++; if(dbg){print "R606", "sw_es_t_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo1; R[607]++; if(dbg){print "R607", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { R[609]++; if(dbg){print "R609", "stopper"}; continue };

 if ( bw(-2,"воздеть") && w(-1,"руки") && s(-2,-1) )
 { l[i]=omo1; R[610]++; if(dbg){print "R610"}; continue };
 ...
 { l[i]=omo1; R[612]++; if(dbg){print "R612"}; continue };
 if ( z(0) &&
      q(1,"otsz_edsrvi") )
 ...
 if ( sw_es_i_f() )
 { l[i]=omo2; R[617]++; if(dbg){print "R617", "sw_es_i_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[618]++; if(dbg){print "R618", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[619]++; if(dbg){print "R619", "sw_ez_p_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[620]++; if(dbg){print "R620", "sw_es_p_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[621]++; if(dbg){print "R621", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_l_f() )
 { l[i]=omo1; R[633]++; if(dbg){print "R633", "sw_ez_l_f"}; continue };
 #
 if ( sw_ez_z_f() )
 { l[i]=omo2; R[634]++; if(dbg){print "R634", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[635]++; if(dbg){print "R635", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[636]++; if(dbg){print "R636", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[637]++; if(dbg){print "R637", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[643]++; if(dbg){print "R643", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[644]++; if(dbg){print "R644", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[645]++; if(dbg){print "R645", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[653]++; if(dbg){print "R653", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[658]++; if(dbg){print "R658", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[666]++; if(dbg){print "R666", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[667]++; if(dbg){print "R667", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[668]++; if(dbg){print "R668", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[669]++; if(dbg){print "R669", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[670]++; if(dbg){print "R670", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[671]++; if(dbg){print "R671", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[672]++; if(dbg){print "R672", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[673]++; if(dbg){print "R673", "sw_mn_v_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[674]++; if(dbg){print "R674", "sw_ez_r_f"}; continue };
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[675]++; if(dbg){print "R675", "pl_krmn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[676]++; if(dbg){print "R676", "gl_poed_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[677]++; if(dbg){print "R677", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo1; R[679]++; if(dbg){print "R679", "sw_mn_r_f"}; continue };
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[680]++; if(dbg){print "R680", "pl_kr_em_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[681]++; if(dbg){print "R681", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[682]++; if(dbg){print "R682", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[683]++; if(dbg){print "R683", "sw_em_i_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[684]++; if(dbg){print "R684", "sw_ez_t_f"}; continue };
 #
 if ( pl_ez_d_f() )
 { l[i]=omo1; R[685]++; if(dbg){print "R685", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo1; R[686]++; if(dbg){print "R686", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo1; R[687]++; if(dbg){print "R687", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo1; R[688]++; if(dbg){print "R688", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
#if ( sL(0,"-") && w(1,cst) )
#{ l[i]=gensub(/(.)$/,"\\1\xcc\x81",1,l[i]); sep[i]=gensub(/-/,"-\xcc\xa0",1,sep[i]); R[694]++; if(dbg){print "R694"}; continue };
#if ( sL(-1,"-") && w(-1,"кое") )
#{ l[i]=gensub(/(.)$/,"\\1\xcc\x81",1,l[i]); R[695]++; if(dbg){print "R695"}; continue };
 if ( sL(0,"-") && w(1,cst) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_p_f() )
 { l[i]=omo2; R[702]++; if(dbg){print "R702", "sw_mn_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[703]++; if(dbg){print "R703", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[707]++; if(dbg){print "R707", "sw_mn_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[708]++; if(dbg){print "R708", "sw_em_d_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if(iwrd=="целиком")
 { l[i]=omo1; R[710]++; if(dbg){print "R710", "nar_spos_"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_d_f() )
 { l[i]=omo2; R[711]++; if(dbg){print "R711", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo2; R[712]++; if(dbg){print "R712", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo2; R[713]++; if(dbg){print "R713", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo2; R[714]++; if(dbg){print "R714", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[727]++; if(dbg){print "R727", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[728]++; if(dbg){print "R728", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[732]++; if(dbg){print "R732", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[733]++; if(dbg){print "R733", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[734]++; if(dbg){print "R734", "sw_mn_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[736]++; if(dbg){print "R736", "sw_em_d_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[737]++; if(dbg){print "R737", "pl_em_p_f()||pl_es_p_f"}; continue };
 #
 if ( sw_em_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[741]++; if(dbg){print "R741", "pl_em_p_f()||pl_es_p_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[742]++; if(dbg){print "R742", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_t_f() )
 { l[i]=omo2; R[744]++; if(dbg){print "R744", "sw_es_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 #
 if ( pl_es_i_f() )
 { l[i]=omo1; R[748]++; if(dbg){print "R748", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo1; R[749]++; if(dbg){print "R749", "pl_es_v_f"}; continue };
 #
 if ( pl_srav_f() )
 { l[i]=omo2; R[750]++; if(dbg){print "R750", "pl_srav_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[751]++; if(dbg){print "R751", "sw_ez_t_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[752]++; if(dbg){print "R752", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[753]++; if(dbg){print "R753", "sw_em_v_f"}; continue };
 #
 if ( pl_ez_d_f() )
 { l[i]=omo1; R[754]++; if(dbg){print "R754", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo1; R[755]++; if(dbg){print "R755", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo1; R[756]++; if(dbg){print "R756", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo1; R[757]++; if(dbg){print "R757", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_d_f() )
 { l[i]=omo1; R[759]++; if(dbg){print "R759", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo1; R[760]++; if(dbg){print "R760", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo1; R[761]++; if(dbg){print "R761", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo1; R[762]++; if(dbg){print "R762", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_d_f() )
 { l[i]=omo1; R[764]++; if(dbg){print "R764", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo1; R[765]++; if(dbg){print "R765", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo1; R[766]++; if(dbg){print "R766", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo1; R[767]++; if(dbg){print "R767", "pl_ez_t_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[768]++; if(dbg){print "R768", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[769]++; if(dbg){print "R769", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[773]++; if(dbg){print "R773", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[774]++; if(dbg){print "R774", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_ez_v_f() )
 { l[i]=omo1; R[775]++; if(dbg){print "R775", "pl_ez_v_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[776]++; if(dbg){print "R776", "sw_es_d_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[778]++; if(dbg){print "R778", "sw_em_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[782]++; if(dbg){print "R782", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[787]++; if(dbg){print "R787", "sw_em_t_f"}; continue };
 #
 if ( pl_kr_em_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[790]++; if(dbg){print "R790", "pl_kr_em_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[791]++; if(dbg){print "R791", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[794]++; if(dbg){print "R794", "pl_kr_em_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[795]++; if(dbg){print "R795", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[796]++; if(dbg){print "R796", "sw_mn_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[798]++; if(dbg){print "R798", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[799]++; if(dbg){print "R799", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[800]++; if(dbg){print "R800", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 ...
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[803]++; if(dbg){print "R803", "pl_kr_ez_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[804]++; if(dbg){print "R804", "sw_em_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[805]++; if(dbg){print "R805", "pl_kr_ez_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[806]++; if(dbg){print "R806", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[809]++; if(dbg){print "R809", "sw_es_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[811]++; if(dbg){print "R811", "sw_ez_i_f"}; continue };
 #
 if ( pl_kr_ez_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[813]++; if(dbg){print "R813", "pl_krmn_f"}; continue };
 #
 if ( sw_ez_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[818]++; if(dbg){print "R818", "pl_krmn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[823]++; if(dbg){print "R823", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[824]++; if(dbg){print "R824", "pl_srav_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[825]++; if(dbg){print "R825", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[828]++; if(dbg){print "R828", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[829]++; if(dbg){print "R829", "pl_srav_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[830]++; if(dbg){print "R830", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[831]++; if(dbg){print "R831", "pl_srav_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[833]++; if(dbg){print "R833", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[834]++; if(dbg){print "R834", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[835]++; if(dbg){print "R835", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[836]++; if(dbg){print "R836", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[837]++; if(dbg){print "R837", "sw_mn_r_f"}; continue };
 #
 if ( pq_kr_em_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[839]++; if(dbg){print "R839", "pq_kr_em_f"}; continue };
 #
 if ( sw_em_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[843]++; if(dbg){print "R843", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[844]++; if(dbg){print "R844", "pl_kr_ez_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[845]++; if(dbg){print "R845", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[846]++; if(dbg){print "R846", "pl_kr_ez_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[847]++; if(dbg){print "R847", "sw_ez_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[848]++; if(dbg){print "R848", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[849]++; if(dbg){print "R849", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[850]++; if(dbg){print "R850", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[851]++; if(dbg){print "R851", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[853]++; if(dbg){print "R853", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[854]++; if(dbg){print "R854", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[855]++; if(dbg){print "R855", "sw_mn_d_f"}; continue };
 #
 if ( sw_mn_d_f() )
 { l[i]=omo2; R[856]++; if(dbg){print "R856", "sw_mn_d_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[857]++; if(dbg){print "R857", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[858]++; if(dbg){print "R858", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[865]++; if(dbg){print "R865", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[866]++; if(dbg){print "R866", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[867]++; if(dbg){print "R867", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[873]++; if(dbg){print "R873", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[877]++; if(dbg){print "R877", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo1; R[878]++; if(dbg){print "R878", "sw_ez_v_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[879]++; if(dbg){print "R879", "sw_em_l_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[884]++; if(dbg){print "R884", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[885]++; if(dbg){print "R885", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_z_f() )
 { l[i]=omo2; R[888]++; if(dbg){print "R888", "sw_em_z_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[889]++; if(dbg){print "R889", "sw_em_d_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[890]++; if(dbg){print "R890", "sw_em_l_f"}; continue };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo1; R[892]++; if(dbg){print "R892", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo1; R[893]++; if(dbg){print "R893", "sw_es_v_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[894]++; if(dbg){print "R894", "sw_em_p_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo1; R[895]++; if(dbg){print "R895", "sw_es_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[900]++; if(dbg){print "R900", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[901]++; if(dbg){print "R901", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[902]++; if(dbg){print "R902", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[905]++; if(dbg){print "R905", "sw_ez_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[913]++; if(dbg){print "R913", "sw_em_d_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo1; R[914]++; if(dbg){print "R914", "sw_es_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo1; R[915]++; if(dbg){print "R915", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[924]++; if(dbg){print "R924", "sw_mn_i_f"}; continue };
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[925]++; if(dbg){print "R925", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[926]++; if(dbg){print "R926", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[927]++; if(dbg){print "R927", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[928]++; if(dbg){print "R928", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[929]++; if(dbg){print "R929", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[930]++; if(dbg){print "R930", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[932]++; if(dbg){print "R932", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[935]++; if(dbg){print "R935", "sw_es_z_f()||sw_es_i_f()||sw_es_v_f()||sw_es_r_f()||sw_es_d_f()||sw_es_t_f()||sw_es_p_f()||sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[939]++; if(dbg){print "R939", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[940]++; if(dbg){print "R940", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[943]++; if(dbg){print "R943", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[944]++; if(dbg){print "R944", "sw_ez_p_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[953]++; if(dbg){print "R953", "sw_ez_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_l_f() )
 { l[i]=omo2; R[954]++; if(dbg){print "R954", "sw_ez_l_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[956]++; if(dbg){print "R956", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[957]++; if(dbg){print "R957", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[958]++; if(dbg){print "R958", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[959]++; if(dbg){print "R959", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[960]++; if(dbg){print "R960", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[961]++; if(dbg){print "R961", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[962]++; if(dbg){print "R962", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[963]++; if(dbg){print "R963", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_l_f() )
 { l[i]=omo2; R[965]++; if(dbg){print "R965", "sw_ez_l_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[966]++; if(dbg){print "R966", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[967]++; if(dbg){print "R967", "sw_ez_r_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[968]++; if(dbg){print "R968", "sw_ez_p_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[969]++; if(dbg){print "R969", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[970]++; if(dbg){print "R970", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[971]++; if(dbg){print "R971", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[972]++; if(dbg){print "R972", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo1; R[973]++; if(dbg){print "R973", "sw_mn_r_f"}; continue };
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[974]++; if(dbg){print "R974", "pl_kr_em_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_d_f() )
 { l[i]=omo2; R[975]++; if(dbg){print "R975", "sw_mn_d_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[976]++; if(dbg){print "R976", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[980]++; if(dbg){print "R980", "sw_em_l_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
#if ( ismark(-1,"Ykl") && notsym(-1,unxy) && s(-1) )
#{ l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[981]++; if(dbg){print "R981"}; continue };
 #
 if ( sw_em_l_f() )
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[984]++; if(dbg){print "R984", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
#if ( ismark(-1,"Ykl") && notsym(-1,unxy) && s(-1) )
#{ l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[985]++; if(dbg){print "R985"}; continue };
 #
 if ( sw_em_z_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
#if ( ismark(-1,"Ykl") && notsym(-1,unxy) && s(-1) )
#{ l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[991]++; if(dbg){print "R991"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[992]++; if(dbg){print "R992", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[993]++; if(dbg){print "R993", "sw_em_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[994]++; if(dbg){print "R994", "sw_em_p_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[995]++; if(dbg){print "R995", "sw_em_d_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[999]++; if(dbg){print "R999", "sw_ez_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1001]++; if(dbg){print "R1001", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[1002]++; if(dbg){print "R1002", "sw_em_i_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[1003]++; if(dbg){print "R1003", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[1004]++; if(dbg){print "R1004", "sw_em_d_f"}; continue };
 #
 if ( sw_em_z_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[1006]++; if(dbg){print "R1006", "sw_em_z_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[1007]++; if(dbg){print "R1007", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1008]++; if(dbg){print "R1008", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[1010]++; if(dbg){print "R1010", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1012]++; if(dbg){print "R1012", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1013]++; if(dbg){print "R1013", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1022]++; if(dbg){print "R1022", "sw_em_i_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1023]++; if(dbg){print "R1023", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1027]++; if(dbg){print "R1027", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[1028]++; if(dbg){print "R1028", "sw_em_t_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1029]++; if(dbg){print "R1029", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1030]++; if(dbg){print "R1030", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1031]++; if(dbg){print "R1031", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1032]++; if(dbg){print "R1032", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_p_f() )
 { l[i]=omo2; R[1033]++; if(dbg){print "R1033", "sw_mn_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1036]++; if(dbg){print "R1036", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1037]++; if(dbg){print "R1037", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1040]++; if(dbg){print "R1040", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1041]++; if(dbg){print "R1041", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1042]++; if(dbg){print "R1042", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1043]++; if(dbg){print "R1043", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[1044]++; if(dbg){print "R1044", "sw_em_d_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[1045]++; if(dbg){print "R1045", "sw_es_d_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[1046]++; if(dbg){print "R1046", "sw_em_l_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1047]++; if(dbg){print "R1047", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1049]++; if(dbg){print "R1049", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1056]++; if(dbg){print "R1056", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1057]++; if(dbg){print "R1057", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1058]++; if(dbg){print "R1058", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1059]++; if(dbg){print "R1059", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[1060]++; if(dbg){print "R1060", "sw_em_p_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[1061]++; if(dbg){print "R1061", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[1066]++; if(dbg){print "R1066", "sw_em_p_f"}; continue };
 #
#if ( sw_es_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1070]++; if(dbg){print "R1070", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1071]++; if(dbg){print "R1071", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_q_f() )
 { l[i]=omo1; R[1072]++; if(dbg){print "R1072", "sw_em_q_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1073]++; if(dbg){print "R1073", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1074]++; if(dbg){print "R1074", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1075]++; if(dbg){print "R1075", "sw_es_v_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1077]++; if(dbg){print "R1077", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1080]++; if(dbg){print "R1080", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1094]++; if(dbg){print "R1094", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1095]++; if(dbg){print "R1095", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1099]++; if(dbg){print "R1099", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1102]++; if(dbg){print "R1102", "sw_em_p_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[1103]++; if(dbg){print "R1103", "sw_es_p_f"}; continue };
 #
 if ( sw_em_t_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[1105]++; if(dbg){print "R1105", "sw_em_t_f"}; continue };
 #
 if ( sw_es_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( nar_spos_f() )
 { l[i]=omo1; R[1109]++; if(dbg){print "R1109", "nar_spos_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[1110]++; if(dbg){print "R1110", "sw_em_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1117]++; if(dbg){print "R1117", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1118]++; if(dbg){print "R1118", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1119]++; if(dbg){print "R1119", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1125]++; if(dbg){print "R1125", "sw_em_r_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1126]++; if(dbg){print "R1126", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1127]++; if(dbg){print "R1127", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1128]++; if(dbg){print "R1128", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1129]++; if(dbg){print "R1129", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1130]++; if(dbg){print "R1130", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1131]++; if(dbg){print "R1131", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1143]++; if(dbg){print "R1143", "gl_paedmu_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1144]++; if(dbg){print "R1144", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_d_f() )
 { l[i]=omo1; R[1145]++; if(dbg){print "R1145", "sw_es_d_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1146]++; if(dbg){print "R1146", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_d_f() )
 { l[i]=omo1; R[1147]++; if(dbg){print "R1147", "sw_es_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1148]++; if(dbg){print "R1148", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo1; R[1149]++; if(dbg){print "R1149", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1150]++; if(dbg){print "R1150", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_v_f() )
 { l[i]=omo1; R[1153]++; if(dbg){print "R1153", "sw_es_v_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[1154]++; if(dbg){print "R1154", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1157]++; if(dbg){print "R1157", "sw_ez_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_p_f() )
 { l[i]=omo1; R[1159]++; if(dbg){print "R1159", "sw_es_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1160]++; if(dbg){print "R1160", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1161]++; if(dbg){print "R1161", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1162]++; if(dbg){print "R1162", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1163]++; if(dbg){print "R1163", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1164]++; if(dbg){print "R1164", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1167]++; if(dbg){print "R1167", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1177]++; if(dbg){print "R1177", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1178]++; if(dbg){print "R1178", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1179]++; if(dbg){print "R1179", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1181]++; if(dbg){print "R1181", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1182]++; if(dbg){print "R1182", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1184]++; if(dbg){print "R1184", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1185]++; if(dbg){print "R1185", "sw_mn_v_f"}; continue };
 #
 cst="деньги";
 if ( W(0,cst) && sw_ez_r_f() )
 { l[i]=omo1; R[1186]++; if(dbg){print "R1186", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[1191]++; if(dbg){print "R1191", "sw_ez_t_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1192]++; if(dbg){print "R1192", "sw_ez_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[1193]++; if(dbg){print "R1193", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1194]++; if(dbg){print "R1194", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[1195]++; if(dbg){print "R1195", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_p_f() )
 { l[i]=omo1; R[1198]++; if(dbg){print "R1198", "sw_mn_p_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1199]++; if(dbg){print "R1199", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_p_f() )
 { l[i]=omo1; R[1200]++; if(dbg){print "R1200", "sw_mn_p_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1201]++; if(dbg){print "R1201", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1215]++; if(dbg){print "R1215", "sw_mn_r_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1216]++; if(dbg){print "R1216", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1222]++; if(dbg){print "R1222", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[1233]++; if(dbg){print "R1233", "sw_em_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1241]++; if(dbg){print "R1241", "sw_es_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[1242]++; if(dbg){print "R1242", "pl_kr_ez_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[1243]++; if(dbg){print "R1243", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[1244]++; if(dbg){print "R1244", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1322]++; if(dbg){print "R1322", "sw_es_z_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[1323]++; if(dbg){print "R1323", "sw_ez_i_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1324]++; if(dbg){print "R1324", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[1332]++; if(dbg){print "R1332", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1333]++; if(dbg){print "R1333", "sw_em_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1335]++; if(dbg){print "R1335", "sw_ez_i_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1336]++; if(dbg){print "R1336", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1356]++; if(dbg){print "R1356", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_v_f() )
 { l[i]=omo2; R[1361]++; if(dbg){print "R1361", "pl_ez_v_f"}; continue };
 #
 if ( suw_mnvi(1) && s(0) )
 { l[i]=omo1; R[1362]++; if(dbg){print "R1362"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1363]++; if(dbg){print "R1363", "gl_ed1e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo2; R[1380]++; if(dbg){print "R1380"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[1394]++; if(dbg){print "R1394", "gl_poed_f"}; continue };
 #
#if ( gl_in_f() )
#{ l[i]=omo1; R[1395]++; if(dbg){print "R1395"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1396]++; if(dbg){print "R1396", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1397]++; if(dbg){print "R1397", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[1398]++; if(dbg){print "R1398", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1399]++; if(dbg){print "R1399", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1400]++; if(dbg){print "R1400", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[1403]++; if(dbg){print "R1403", "sw_em_z_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1404]++; if(dbg){print "R1404", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1405]++; if(dbg){print "R1405", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1406]++; if(dbg){print "R1406", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1407]++; if(dbg){print "R1407", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1408]++; if(dbg){print "R1408", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1412]++; if(dbg){print "R1412", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1413]++; if(dbg){print "R1413", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_z_f() )
 { l[i]=omo1; R[1416]++; if(dbg){print "R1416", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1417]++; if(dbg){print "R1417", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1423]++; if(dbg){print "R1423", "sw_em_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1432]++; if(dbg){print "R1432", "gl_paedmu_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1433]++; if(dbg){print "R1433", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[1434]++; if(dbg){print "R1434", "sw_em_z_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[1439]++; if(dbg){print "R1439", "gl_poed_f"}; continue };
 #
 if ( sw_ez_z_f() )
 { l[i]=omo2; R[1440]++; if(dbg){print "R1440", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[1441]++; if(dbg){print "R1441", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1442]++; if(dbg){print "R1442", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1443]++; if(dbg){print "R1443", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( q(-2,"prl_kred_sr") &&
sz_iili(-1) && s(-2,-1) )
 { l[i]=omo2; R[1446]++; if(dbg){print "R1446", "gl_paedsr_f"}; continue };
 ...
 if ( gl_paedsr_f() )
 { l[i]=omo1; R[1450]++; if(dbg){print "R1450", "gl_paedsr_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( w(-1,"на") && s(-1) )
 { l[i]=omo2; R[1451]++; if(dbg){print "R1451", "sw_ez_d_f"}; continue };
 #
 if ( sw_em_p_f() )
 ...
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1454]++; if(dbg){print "R1454", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1462]++; if(dbg){print "R1462", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[1463]++; if(dbg){print "R1463", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1464]++; if(dbg){print "R1464", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[1465]++; if(dbg){print "R1465", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1466]++; if(dbg){print "R1466", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1467]++; if(dbg){print "R1467", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1468]++; if(dbg){print "R1468", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( q(-2,"suw_tv") &&
sz_iili(-1) && s(-2,-1) )
 { l[i]=omo2; R[1472]++; if(dbg){print "R1472", "sw_em_t_f"}; continue };
 #
 if ( sw_em_p_f()||sw_es_p_f()||pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[1473]++; if(dbg){print "R1473", "sw_em_p_f||sw_es_p_f||pl_em_p_f||pl_es_p_f"}; continue };
 #
 if ( sw_em_t_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[1475]++; if(dbg){print "R1475", "pl_srav_f"}; continue };
 #
 cst="значительно куда лишь много намного немного несколько";
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo1; R[1476]++; if(dbg){print "R1476"}; continue };
 if ( nar_vrem_f() )
 { l[i]=omo1; R[1477]++; if(dbg){print "R1477", "nar_vrem_f"}; continue };
 #
 if ( pl_es_i_f() )
 { l[i]=omo2; R[1478]++; if(dbg){print "R1478", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo2; R[1479]++; if(dbg){print "R1479", "pl_es_v_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[1480]++; if(dbg){print "R1480", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[1481]++; if(dbg){print "R1481", "sw_em_d_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1482]++; if(dbg){print "R1482", "gl_ed1e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[1483]++; if(dbg){print "R1483", "sw_ez_d_f"}; continue };
 #
 if ( sw_em_p_f() )           ##_footer
 { l[i]=omo1; R[1484]++; if(dbg){print "R1484", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1485]++; if(dbg){print "R1485", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_em_p_f() )
 { l[i]=omo2; R[1487]++; if(dbg){print "R1487", "sw_ez_d_f"}; continue };
 #
 if ( pl_es_p_f() )
 { l[i]=omo2; R[1488]++; if(dbg){print "R1488", "sw_em_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[1489]++; if(dbg){print "R1489", "sw_ez_d_f"}; continue };
 #
 if ( pl_srav_f() )
 { l[i]=omo2; R[1490]++; if(dbg){print "R1490", "sw_em_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1493]++; if(dbg){print "R1493", "sw_mn_r_f"}; continue };
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1494]++; if(dbg){print "R1494", "gl_paedmu_f"}; continue };
...
#{ l[i]=omo1; l[i+1]=gensub(/^(.+)$/,"\xcc\xa0\\1\xcc\xa0",1,l[i+1]); R[1496]++; if(dbg){print "R1496"}; continue };
 if ( sL(0,"-") )
 { l[i]=omo1; R[1497]++; if(dbg){print "R1497"}; continue };
 #
 if ( pl_ez_i_f() )
 { l[i]=omo1; R[1498]++; if(dbg){print "R1498", "pl_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[1505]++; if(dbg){print "R1505", "pl_kr_ez_f"}; continue };
 #
 if ( sw_ez_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( w(-1,"из-под") && s(-1) )
 { l[i]=omo2; R[1507]++; if(dbg){print "R1507"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1508]++; if(dbg){print "R1508", "sw_ez_r_f"}; continue };
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[1509]++; if(dbg){print "R1509", "pl_krmn_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1510]++; if(dbg){print "R1510", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[1511]++; if(dbg){print "R1511", "sw_em_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1512]++; if(dbg){print "R1512", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if(iwrd=="они") {
   l[i]=omo2; R[1513]++; if(dbg){print "R1513"}; continue # они́
 };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if(iwrd=="собой") {
   l[i]=omo2; R[1514]++; if(dbg){print "R1514"}; continue # они́
 };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[1517]++; if(dbg){print "R1517"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1525]++; if(dbg){print "R1525", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo3; R[1526]++; if(dbg){print "R1526", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1527]++; if(dbg){print "R1527", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1528]++; if(dbg){print "R1528", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1529]++; if(dbg){print "R1529", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo3; R[1530]++; if(dbg){print "R1530", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1531]++; if(dbg){print "R1531", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1532]++; if(dbg){print "R1532", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1533]++; if(dbg){print "R1533", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[1535]++; if(dbg){print "R1535", "sw_mn_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1536]++; if(dbg){print "R1536", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1537]++; if(dbg){print "R1537", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo3; R[1538]++; if(dbg){print "R1538", "sw_ez_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[1539]++; if(dbg){print "R1539", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo3; R[1540]++; if(dbg){print "R1540", "sw_ez_v_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1541]++; if(dbg){print "R1541", "gl_ed1e_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1542]++; if(dbg){print "R1542", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1543]++; if(dbg){print "R1543", "sw_es_v_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo3; R[1544]++; if(dbg){print "R1544", "sw_es_p_f"}; continue };
 #
 if ( pl_es_i_f() )
 { l[i]=omo1; R[1545]++; if(dbg){print "R1545", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo1; R[1546]++; if(dbg){print "R1546", "pl_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1548]++; if(dbg){print "R1548", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1549]++; if(dbg){print "R1549", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1550]++; if(dbg){print "R1550", "sw_mn_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[1551]++; if(dbg){print "R1551", "sw_em_l_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1552]++; if(dbg){print "R1552", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo3; R[1553]++; if(dbg){print "R1553", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_ed3e_f() )
 { l[i]=omo1; R[1554]++; if(dbg){print "R1554", "gl_ed3e_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo3; R[1555]++; if(dbg){print "R1555", "sw_mn_r_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[1556]++; if(dbg){print "R1556", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1557]++; if(dbg){print "R1557", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1558]++; if(dbg){print "R1558", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo3; R[1559]++; if(dbg){print "R1559", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo3; R[1560]++; if(dbg){print "R1560", "sw_ez_p_f"}; continue };
 #
 if ( gl_mn2e_f() )
 { l[i]=omo1; R[1561]++; if(dbg){print "R1561", "gl_mn2e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_mn2e_f() )
 { l[i]=omo3; R[1562]++; if(dbg){print "R1562", "gl_mn2e_f"}; continue };
 #
 if ( gl_pomn_f() )
 { l[i]=omo2; R[1563]++; if(dbg){print "R1563", "gl_pomn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1564]++; if(dbg){print "R1564", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[1565]++; if(dbg){print "R1565", "sw_mn_i_f"}; continue };
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[1566]++; if(dbg){print "R1566", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1567]++; if(dbg){print "R1567", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1569]++; if(dbg){print "R1569", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1570]++; if(dbg){print "R1570", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo3; R[1571]++; if(dbg){print "R1571", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[1572]++; if(dbg){print "R1572", "pl_srav_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1573]++; if(dbg){print "R1573", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1574]++; if(dbg){print "R1574", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo3; R[1575]++; if(dbg){print "R1575", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
   ...
   if ( qxs(1,"без",cst) )
   { l[i]=omo1; R[1651]++; if(dbg){print "R1651"}; continue };
