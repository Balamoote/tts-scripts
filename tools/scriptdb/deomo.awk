...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if(iwrd=="свою") {
   ...
   l[i]=omo1; R[156]++; if(dbg){print "R156"}; continue # свою́
 };
 #
 if ( pre_vi(-1) &&
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_kr_em_f() )
 { l[i]=omo2; R[321]++; if(dbg){print "R321", "pl_kr_em_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if(iwrd=="целиком")
 { l[i]=omo1; R[697]++; if(dbg){print "R697", "nar_spos_"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_d_f() )
 { l[i]=omo2; R[698]++; if(dbg){print "R698", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo2; R[699]++; if(dbg){print "R699", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo2; R[700]++; if(dbg){print "R700", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo2; R[701]++; if(dbg){print "R701", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[707]++; if(dbg){print "R707", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[714]++; if(dbg){print "R714", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[721]++; if(dbg){print "R721", "sw_mn_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[722]++; if(dbg){print "R722", "sw_em_p_f"}; continue };
 #
 if ( sw_em_t_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[724]++; if(dbg){print "R724", "sw_em_d_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[731]++; if(dbg){print "R731", "pl_em_p_f()||pl_es_p_f"}; continue };
 #
 if ( sw_es_t_f() )
 { l[i]=omo2; R[732]++; if(dbg){print "R732", "sw_es_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[733]++; if(dbg){print "R733", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 #
 if ( pl_es_i_f() )
 { l[i]=omo1; R[736]++; if(dbg){print "R736", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo1; R[737]++; if(dbg){print "R737", "pl_es_v_f"}; continue };
 #
 if ( pl_srav_f() )
 { l[i]=omo2; R[738]++; if(dbg){print "R738", "pl_srav_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[740]++; if(dbg){print "R740", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[741]++; if(dbg){print "R741", "sw_em_v_f"}; continue };
 #
 if ( pl_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[746]++; if(dbg){print "R746", "sw_ez_t_f"}; continue };
 #
 if ( pl_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[751]++; if(dbg){print "R751", "sw_mn_r_f"}; continue };
 #
 if ( pl_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[758]++; if(dbg){print "R758", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[759]++; if(dbg){print "R759", "sw_es_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[761]++; if(dbg){print "R761", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[762]++; if(dbg){print "R762", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_ez_v_f() )
 { l[i]=omo1; R[763]++; if(dbg){print "R763", "pl_ez_v_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[764]++; if(dbg){print "R764", "sw_es_d_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[768]++; if(dbg){print "R768", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[769]++; if(dbg){print "R769", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[774]++; if(dbg){print "R774", "sw_em_t_f"}; continue };
 #
 if ( pl_kr_em_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[781]++; if(dbg){print "R781", "pl_kr_em_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[785]++; if(dbg){print "R785", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[786]++; if(dbg){print "R786", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[787]++; if(dbg){print "R787", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[793]++; if(dbg){print "R793", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[794]++; if(dbg){print "R794", "sw_em_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[796]++; if(dbg){print "R796", "sw_es_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[798]++; if(dbg){print "R798", "sw_ez_i_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[799]++; if(dbg){print "R799", "pl_kr_ez_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[804]++; if(dbg){print "R804", "sw_ez_r_f"}; continue };
 #
 if ( pl_krmn_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[808]++; if(dbg){print "R808", "pl_krmn_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[809]++; if(dbg){print "R809", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[815]++; if(dbg){print "R815", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[818]++; if(dbg){print "R818", "pl_srav_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[820]++; if(dbg){print "R820", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[827]++; if(dbg){print "R827", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[829]++; if(dbg){print "R829", "pq_kr_em_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[830]++; if(dbg){print "R830", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[832]++; if(dbg){print "R832", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[833]++; if(dbg){print "R833", "pl_kr_ez_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[834]++; if(dbg){print "R834", "sw_ez_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[837]++; if(dbg){print "R837", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[840]++; if(dbg){print "R840", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[841]++; if(dbg){print "R841", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[842]++; if(dbg){print "R842", "sw_mn_d_f"}; continue };
 #
 if ( sw_mn_d_f() )
 { l[i]=omo2; R[843]++; if(dbg){print "R843", "sw_mn_d_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[844]++; if(dbg){print "R844", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[845]++; if(dbg){print "R845", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[852]++; if(dbg){print "R852", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[853]++; if(dbg){print "R853", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[854]++; if(dbg){print "R854", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[859]++; if(dbg){print "R859", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[865]++; if(dbg){print "R865", "sw_em_l_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[866]++; if(dbg){print "R866", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_z_f() )
 { l[i]=omo2; R[874]++; if(dbg){print "R874", "sw_em_z_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[875]++; if(dbg){print "R875", "sw_em_d_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[876]++; if(dbg){print "R876", "sw_em_l_f"}; continue };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo1; R[878]++; if(dbg){print "R878", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo1; R[879]++; if(dbg){print "R879", "sw_es_v_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[880]++; if(dbg){print "R880", "sw_em_p_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo1; R[881]++; if(dbg){print "R881", "sw_es_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[882]++; if(dbg){print "R882", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[883]++; if(dbg){print "R883", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[888]++; if(dbg){print "R888", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[889]++; if(dbg){print "R889", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[890]++; if(dbg){print "R890", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[891]++; if(dbg){print "R891", "sw_ez_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[892]++; if(dbg){print "R892", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_r_f() )
 ...
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[895]++; if(dbg){print "R895", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[896]++; if(dbg){print "R896", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[899]++; if(dbg){print "R899", "sw_em_d_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo1; R[900]++; if(dbg){print "R900", "sw_es_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo1; R[901]++; if(dbg){print "R901", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[912]++; if(dbg){print "R912", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[913]++; if(dbg){print "R913", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[917]++; if(dbg){print "R917", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[918]++; if(dbg){print "R918", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[921]++; if(dbg){print "R921", "sw_es_z_f()||sw_es_i_f()||sw_es_v_f()||sw_es_r_f()||sw_es_d_f()||sw_es_t_f()||sw_es_p_f()||sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[922]++; if(dbg){print "R922", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[923]++; if(dbg){print "R923", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[924]++; if(dbg){print "R924", "sw_ez_i_f"}; continue };
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[925]++; if(dbg){print "R925", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[926]++; if(dbg){print "R926", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[929]++; if(dbg){print "R929", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[930]++; if(dbg){print "R930", "sw_ez_p_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[939]++; if(dbg){print "R939", "sw_ez_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[942]++; if(dbg){print "R942", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[946]++; if(dbg){print "R946", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[947]++; if(dbg){print "R947", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_l_f() )
 { l[i]=omo2; R[951]++; if(dbg){print "R951", "sw_ez_l_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[952]++; if(dbg){print "R952", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[953]++; if(dbg){print "R953", "sw_ez_r_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[954]++; if(dbg){print "R954", "sw_ez_p_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[955]++; if(dbg){print "R955", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[956]++; if(dbg){print "R956", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[957]++; if(dbg){print "R957", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[958]++; if(dbg){print "R958", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo1; R[959]++; if(dbg){print "R959", "sw_mn_r_f"}; continue };
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[960]++; if(dbg){print "R960", "pl_kr_em_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_d_f() )
 { l[i]=omo2; R[961]++; if(dbg){print "R961", "sw_mn_d_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[962]++; if(dbg){print "R962", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[963]++; if(dbg){print "R963", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[964]++; if(dbg){print "R964", "sw_ez_v_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[965]++; if(dbg){print "R965", "sw_em_d_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[966]++; if(dbg){print "R966", "sw_em_l_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
#{ l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[967]++; if(dbg){print "R967"}; continue };
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[970]++; if(dbg){print "R970", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
#{ l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[971]++; if(dbg){print "R971"}; continue };
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[972]++; if(dbg){print "R972", "sw_em_z_f"}; continue };
 #
 if ( sw_em_l_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
#if ( ismark(-1,"Ykl") && notsym(-1,unxy) && s(-1) )
#{ l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[977]++; if(dbg){print "R977"}; continue };
 #
 if ( sw_em_l_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[980]++; if(dbg){print "R980", "sw_em_p_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[985]++; if(dbg){print "R985", "sw_ez_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[988]++; if(dbg){print "R988", "sw_em_i_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[989]++; if(dbg){print "R989", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[992]++; if(dbg){print "R992", "sw_em_z_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[993]++; if(dbg){print "R993", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[994]++; if(dbg){print "R994", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[998]++; if(dbg){print "R998", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[999]++; if(dbg){print "R999", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if(iwrd=="черт") {
   cst="что кто где как когда сколько как насколько куда зачем че"
   if ( qxs(1,"знает",cst) )
   ...
   if ( p(-1) && p(0) )
   { l[i]=omo1; R[1013]++; if(dbg){print "R1013"}; continue };
   cst="побрать подрать взять драть знать дернуть";
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[1007]++; if(dbg){print "R1007", "sw_em_t_f"}; continue };
 #
 if ( sw_em_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_p_f() )
 { l[i]=omo2; R[1012]++; if(dbg){print "R1012", "sw_mn_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[1023]++; if(dbg){print "R1023", "sw_em_d_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[1024]++; if(dbg){print "R1024", "sw_es_d_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[1025]++; if(dbg){print "R1025", "sw_em_l_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1026]++; if(dbg){print "R1026", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1035]++; if(dbg){print "R1035", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1036]++; if(dbg){print "R1036", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1037]++; if(dbg){print "R1037", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1038]++; if(dbg){print "R1038", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[1040]++; if(dbg){print "R1040", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1041]++; if(dbg){print "R1041", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1042]++; if(dbg){print "R1042", "sw_es_v_f"}; continue };
 #
 if ( sw_em_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1049]++; if(dbg){print "R1049", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1050]++; if(dbg){print "R1050", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_q_f() )
 { l[i]=omo1; R[1051]++; if(dbg){print "R1051", "sw_em_q_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1052]++; if(dbg){print "R1052", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1057]++; if(dbg){print "R1057", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1058]++; if(dbg){print "R1058", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1059]++; if(dbg){print "R1059", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1072]++; if(dbg){print "R1072", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1078]++; if(dbg){print "R1078", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1079]++; if(dbg){print "R1079", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1080]++; if(dbg){print "R1080", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1081]++; if(dbg){print "R1081", "sw_em_p_f"}; continue };
 #
 if ( sw_es_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[1085]++; if(dbg){print "R1085", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( nar_spos_f() )
 { l[i]=omo1; R[1088]++; if(dbg){print "R1088", "nar_spos_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[1089]++; if(dbg){print "R1089", "sw_em_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1090]++; if(dbg){print "R1090", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1094]++; if(dbg){print "R1094", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1105]++; if(dbg){print "R1105", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1106]++; if(dbg){print "R1106", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1107]++; if(dbg){print "R1107", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1108]++; if(dbg){print "R1108", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1120]++; if(dbg){print "R1120", "gl_paedmu_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1121]++; if(dbg){print "R1121", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1123]++; if(dbg){print "R1123", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_d_f() )
 { l[i]=omo1; R[1124]++; if(dbg){print "R1124", "sw_es_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1127]++; if(dbg){print "R1127", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_i_f() )
 { l[i]=omo1; R[1129]++; if(dbg){print "R1129", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo1; R[1130]++; if(dbg){print "R1130", "sw_es_v_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[1131]++; if(dbg){print "R1131", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1135]++; if(dbg){print "R1135", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_p_f() )
 { l[i]=omo1; R[1136]++; if(dbg){print "R1136", "sw_es_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1137]++; if(dbg){print "R1137", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1139]++; if(dbg){print "R1139", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1140]++; if(dbg){print "R1140", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1141]++; if(dbg){print "R1141", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1143]++; if(dbg){print "R1143", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1154]++; if(dbg){print "R1154", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1157]++; if(dbg){print "R1157", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1162]++; if(dbg){print "R1162", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1166]++; if(dbg){print "R1166", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1169]++; if(dbg){print "R1169", "sw_ez_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_p_f() )
 { l[i]=omo1; R[1177]++; if(dbg){print "R1177", "sw_mn_p_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1192]++; if(dbg){print "R1192", "sw_mn_r_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1199]++; if(dbg){print "R1199", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[1210]++; if(dbg){print "R1210", "sw_em_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1218]++; if(dbg){print "R1218", "sw_es_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[1219]++; if(dbg){print "R1219", "pl_kr_ez_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[1220]++; if(dbg){print "R1220", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[1221]++; if(dbg){print "R1221", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1299]++; if(dbg){print "R1299", "sw_es_z_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[1300]++; if(dbg){print "R1300", "sw_ez_i_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1301]++; if(dbg){print "R1301", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1302]++; if(dbg){print "R1302", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1303]++; if(dbg){print "R1303", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[1309]++; if(dbg){print "R1309", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1310]++; if(dbg){print "R1310", "sw_em_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1312]++; if(dbg){print "R1312", "sw_ez_i_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1313]++; if(dbg){print "R1313", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1334]++; if(dbg){print "R1334", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1335]++; if(dbg){print "R1335", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1336]++; if(dbg){print "R1336", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_v_f() )
 { l[i]=omo2; R[1339]++; if(dbg){print "R1339", "pl_ez_v_f"}; continue };
 #
 if ( suw_mnvi(1) && s(0) )
 { l[i]=omo1; R[1340]++; if(dbg){print "R1340"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1341]++; if(dbg){print "R1341", "gl_ed1e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1369]++; if(dbg){print "R1369", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[1372]++; if(dbg){print "R1372", "gl_poed_f"}; continue };
 #
#if ( gl_in_f() )
#{ l[i]=omo1; R[1373]++; if(dbg){print "R1373"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1374]++; if(dbg){print "R1374", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1375]++; if(dbg){print "R1375", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[1376]++; if(dbg){print "R1376", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[1381]++; if(dbg){print "R1381", "sw_em_z_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1382]++; if(dbg){print "R1382", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1385]++; if(dbg){print "R1385", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1386]++; if(dbg){print "R1386", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1387]++; if(dbg){print "R1387", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1388]++; if(dbg){print "R1388", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( bw(-1,"мочка") && s(-1) )
 { l[i]=omo1; R[1389]++; if(dbg){print "R1389", "sw_es_r_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1390]++; if(dbg){print "R1390", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1391]++; if(dbg){print "R1391", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_z_f() )
 { l[i]=omo1; R[1394]++; if(dbg){print "R1394", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1395]++; if(dbg){print "R1395", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1396]++; if(dbg){print "R1396", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1397]++; if(dbg){print "R1397", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( w(1,"к как") && s(0) )
 { l[i]=omo2; R[1400]++; if(dbg){print "R1400"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1401]++; if(dbg){print "R1401", "sw_em_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1410]++; if(dbg){print "R1410", "gl_paedmu_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1411]++; if(dbg){print "R1411", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[1412]++; if(dbg){print "R1412", "sw_em_z_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1413]++; if(dbg){print "R1413", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1414]++; if(dbg){print "R1414", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[1417]++; if(dbg){print "R1417", "gl_poed_f"}; continue };
 #
 if ( sw_ez_z_f() )
 { l[i]=omo2; R[1418]++; if(dbg){print "R1418", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[1419]++; if(dbg){print "R1419", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1420]++; if(dbg){print "R1420", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1421]++; if(dbg){print "R1421", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo2; R[1423]++; if(dbg){print "R1423", "gl_paedsr_f"}; continue };
 if ( q(-2,"prl_kred_sr") &&
sz_iili(-1) && s(-2,-1) )
 ...
 if ( gl_paedsr_f() )
 { l[i]=omo1; R[1428]++; if(dbg){print "R1428", "gl_paedsr_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if(iwrd=="спине") {
   prex=0
   if ( sw_em_p_f() )
   { l[i]=omo2; R[1437]++; if(dbg){print "R1437", "sw_em_p_f"}; continue };
   prex=1
 };
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[1438]++; if(dbg){print "R1438", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1439]++; if(dbg){print "R1439", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1440]++; if(dbg){print "R1440", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1445]++; if(dbg){print "R1445", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1446]++; if(dbg){print "R1446", "sw_ez_i_f"}; continue };
...
sz_iili(-1) && s(-2,-1) )
 ...
 { l[i]=omo1; R[1451]++; if(dbg){print "R1451", "sw_em_p_f||sw_es_p_f||pl_em_p_f||pl_es_p_f"}; continue };
 #
 if ( sw_em_t_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[1453]++; if(dbg){print "R1453", "pl_srav_f"}; continue };
 #
 cst="значительно куда лишь много намного немного несколько";
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo1; R[1454]++; if(dbg){print "R1454"}; continue };
 if ( nar_vrem_f() )
 { l[i]=omo1; R[1455]++; if(dbg){print "R1455", "nar_vrem_f"}; continue };
 #
 if ( pl_es_i_f() )
 { l[i]=omo2; R[1456]++; if(dbg){print "R1456", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo2; R[1457]++; if(dbg){print "R1457", "pl_es_v_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[1458]++; if(dbg){print "R1458", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[1459]++; if(dbg){print "R1459", "sw_em_d_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1460]++; if(dbg){print "R1460", "gl_ed1e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[1462]++; if(dbg){print "R1462", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1463]++; if(dbg){print "R1463", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_em_p_f() )
 { l[i]=omo2; R[1465]++; if(dbg){print "R1465", "sw_ez_d_f"}; continue };
 #
 if ( pl_es_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[1467]++; if(dbg){print "R1467", "sw_ez_d_f"}; continue };
 #
 if ( pl_srav_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1471]++; if(dbg){print "R1471", "sw_mn_r_f"}; continue };
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1472]++; if(dbg){print "R1472", "gl_paedmu_f"}; continue };
...
#{ l[i]=omo1; l[i+1]=gensub(/^(.+)$/,"\xcc\xa0\\1\xcc\xa0",1,l[i+1]); R[1474]++; if(dbg){print "R1474"}; continue };
 if ( sL(0,"-") )
 { l[i]=omo1; R[1475]++; if(dbg){print "R1475"}; continue };
 #
 if ( pl_ez_i_f() )
 { l[i]=omo1; R[1476]++; if(dbg){print "R1476", "pl_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1479]++; if(dbg){print "R1479", "sw_em_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[1480]++; if(dbg){print "R1480", "pl_kr_ez_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1481]++; if(dbg){print "R1481", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( w(-1,"из-под") && s(-1) )
 { l[i]=omo2; R[1482]++; if(dbg){print "R1482"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1483]++; if(dbg){print "R1483", "sw_ez_r_f"}; continue };
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[1484]++; if(dbg){print "R1484", "pl_krmn_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1485]++; if(dbg){print "R1485", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[1479]++; if(dbg){print "R1479", "sw_em_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1481]++; if(dbg){print "R1481", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if(iwrd=="они") {
   l[i]=omo2; R[156]++; if(dbg){print "R156"}; continue # они́
 };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[1481]++; if(dbg){print "R1481"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1490]++; if(dbg){print "R1490", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo3; R[1491]++; if(dbg){print "R1491", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1492]++; if(dbg){print "R1492", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1493]++; if(dbg){print "R1493", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1494]++; if(dbg){print "R1494", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo3; R[1495]++; if(dbg){print "R1495", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[1496]++; if(dbg){print "R1496", "sw_mn_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1497]++; if(dbg){print "R1497", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1498]++; if(dbg){print "R1498", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo3; R[1499]++; if(dbg){print "R1499", "sw_ez_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[1500]++; if(dbg){print "R1500", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo3; R[1501]++; if(dbg){print "R1501", "sw_ez_v_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1502]++; if(dbg){print "R1502", "gl_ed1e_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1503]++; if(dbg){print "R1503", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1504]++; if(dbg){print "R1504", "sw_es_v_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo3; R[1505]++; if(dbg){print "R1505", "sw_es_p_f"}; continue };
 #
 if ( pl_es_i_f() )
 { l[i]=omo1; R[1506]++; if(dbg){print "R1506", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo1; R[1507]++; if(dbg){print "R1507", "pl_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1509]++; if(dbg){print "R1509", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1510]++; if(dbg){print "R1510", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[1512]++; if(dbg){print "R1512", "sw_em_l_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1513]++; if(dbg){print "R1513", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo3; R[1514]++; if(dbg){print "R1514", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_ed3e_f() )
 { l[i]=omo1; R[1515]++; if(dbg){print "R1515", "gl_ed3e_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo3; R[1516]++; if(dbg){print "R1516", "sw_mn_r_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[1517]++; if(dbg){print "R1517", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1518]++; if(dbg){print "R1518", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1519]++; if(dbg){print "R1519", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo3; R[1520]++; if(dbg){print "R1520", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo3; R[1521]++; if(dbg){print "R1521", "sw_ez_p_f"}; continue };
 #
 if ( gl_mn2e_f() )
 { l[i]=omo1; R[1522]++; if(dbg){print "R1522", "gl_mn2e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_mn2e_f() )
 { l[i]=omo3; R[1523]++; if(dbg){print "R1523", "gl_mn2e_f"}; continue };
 #
 if ( gl_pomn_f() )
 { l[i]=omo2; R[1524]++; if(dbg){print "R1524", "gl_pomn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1525]++; if(dbg){print "R1525", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[1526]++; if(dbg){print "R1526", "sw_mn_i_f"}; continue };
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[1527]++; if(dbg){print "R1527", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1528]++; if(dbg){print "R1528", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo3; R[1532]++; if(dbg){print "R1532", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[1533]++; if(dbg){print "R1533", "pl_srav_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1534]++; if(dbg){print "R1534", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1535]++; if(dbg){print "R1535", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo3; R[1536]++; if(dbg){print "R1536", "sw_mn_r_f"}; continue };
